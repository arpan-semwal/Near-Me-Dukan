              ...
              <div style={{
                ...
                <Collapse in={openStore} timeout="auto" unmountOnExit>
                  <List component="div" disablePadding>
                    ...
                    <ListItem button>
                      <ListItemText primary="Category 3" primaryTypographyProps={{ color: 'white' }} />
                    </ListItem>
                  </List>
                </Collapse>
              </div>
            ...
            {(state) => (
              <div style={{
                ...
                <Collapse in={openMainCategory} timeout="auto" unmountOnExit>
                  <List component="div" disablePadding>
                    <ListItem button>
                      <ListItemText primary="Subcategory 1" primaryTypographyProps={{ color: 'white' }} />
                    </ListItem>
                    <ListItem button>
                      <ListItemText primary="Subcategory 2" primaryTypographyProps={{ color: 'white' }} />
                    </ListItem>
                    <ListItem button>
                      <ListItemText primary="Subcategory 3" primaryTypographyProps={{ color: 'white' }} />
                    </ListItem>
                  </List>
                </Collapse>
              </div>
